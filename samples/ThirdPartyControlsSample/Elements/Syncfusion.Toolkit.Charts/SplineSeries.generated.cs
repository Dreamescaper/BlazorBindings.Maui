...
namespace BlazorBindings.Maui.Elements.Syncfusion.Toolkit.Charts
{
    ...
    public partial class SplineSeries : XYDataSeries
    {
        ...
        public new SMTC.SplineSeries NativeControl => (SMTC.SplineSeries)((BindableObject)this).NativeControl;

        protected override SMTC.SplineSeries CreateNativeElement() => new();
            ...
            switch (name)
            {
                case nameof(ShowMarkers):
                    if (!Equals(ShowMarkers, value))
                    {
                        ...
                        NativeControl.ShowMarkers = ShowMarkers ?? (bool)SMTC.SplineSeries.ShowMarkersProperty.DefaultValue;
                    }
                    break;
                case nameof(Type):
                    if (!Equals(Type, value))
                    {
                        ...
                        NativeControl.Type = Type ?? (SMTC.SplineType)SMTC.SplineSeries.TypeProperty.DefaultValue;
                    }
                    break;
        ...
        protected override void RenderAdditionalElementContent(RenderTreeBuilder builder, ref int sequence)
        {
            ...
            RenderTreeBuilderHelper.AddContentProperty<SMTC.SplineSeries>(builder, sequence++, MarkerSettings, (x, value) => x.MarkerSettings = (SMTC.ChartMarkerSettings)value);
        }
