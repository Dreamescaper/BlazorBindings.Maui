...
{
    /// <summary>
    /// The <see cref="T:Syncfusion.Maui.Toolkit.Charts.StackingLineSeries" /> is a collection of data points, where the lines are stacked on top of each other.
    /// </summary>
    public partial class StackingLineSeries<T> : StackingSeriesBase<T>
    {
        static StackingLineSeries()
        {
        ...
        public new SMTC.StackingLineSeries NativeControl => (SMTC.StackingLineSeries)((BindableObject)this).NativeControl;

        protected override SMTC.StackingLineSeries CreateNativeElement() => new();
        ...
        protected override void RenderAdditionalElementContent(RenderTreeBuilder builder, ref int sequence)
        {
            ...
            RenderTreeBuilderHelper.AddContentProperty<SMTC.StackingLineSeries>(builder, sequence++, MarkerSettings, (x, value) => x.MarkerSettings = (SMTC.ChartMarkerSettings)value);
        }
