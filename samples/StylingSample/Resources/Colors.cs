...
public static class Colors
{
    ...
    public static readonly Color White = MauiColors.White;
    public static readonly Color Black = MauiColors.Black;
    public static readonly Color Transparent = MauiColors.Transparent;
